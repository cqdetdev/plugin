...
use crate::{PluginSubscriptions, Server, event::EventContext, types};
...
pub trait PluginEventHandler: PluginSubscriptions + Send + Sync {
    ...
    async fn on_player_join(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerJoinEvent>,
    ) {
    }
    ...
    async fn on_player_quit(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerQuitEvent>,
    ) {
    }
    ...
    async fn on_player_move(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerMoveEvent>,
    ) {
    }
    ...
    async fn on_player_jump(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerJumpEvent>,
    ) {
    }
    ...
    async fn on_player_teleport(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerTeleportEvent>,
    ) {
    }
    ...
    async fn on_player_change_world(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerChangeWorldEvent>,
    ) {
    }
    ...
    async fn on_player_toggle_sprint(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerToggleSprintEvent>,
    ) {
    }
    ...
    async fn on_player_toggle_sneak(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerToggleSneakEvent>,
    ) {
    }
    ///Handler for the `Chat` event.
    async fn on_chat(&self, _server: &Server, _event: &mut EventContext<types::ChatEvent>) {}
    ///Handler for the `PlayerFoodLoss` event.
    async fn on_player_food_loss(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerFoodLossEvent>,
    ) {
    }
    ...
    async fn on_player_heal(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerHealEvent>,
    ) {
    }
    ...
    async fn on_player_hurt(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerHurtEvent>,
    ) {
    }
    ...
    async fn on_player_death(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerDeathEvent>,
    ) {
    }
    ...
    async fn on_player_respawn(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerRespawnEvent>,
    ) {
    }
    ...
    async fn on_player_skin_change(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerSkinChangeEvent>,
    ) {
    }
    ...
    async fn on_player_fire_extinguish(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerFireExtinguishEvent>,
    ) {
    }
    ...
    async fn on_player_start_break(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerStartBreakEvent>,
    ) {
    }
    ...
    async fn on_block_break(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::BlockBreakEvent>,
    ) {
    }
    ...
    async fn on_player_block_place(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerBlockPlaceEvent>,
    ) {
    }
    ...
    async fn on_player_block_pick(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerBlockPickEvent>,
    ) {
    }
    ...
    async fn on_player_item_use(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemUseEvent>,
    ) {
    }
    ...
    async fn on_player_item_use_on_block(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemUseOnBlockEvent>,
    ) {
    }
    ...
    async fn on_player_item_use_on_entity(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemUseOnEntityEvent>,
    ) {
    }
    ...
    async fn on_player_item_release(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemReleaseEvent>,
    ) {
    }
    ...
    async fn on_player_item_consume(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemConsumeEvent>,
    ) {
    }
    ...
    async fn on_player_attack_entity(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerAttackEntityEvent>,
    ) {
    }
    ...
    async fn on_player_experience_gain(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerExperienceGainEvent>,
    ) {
    }
    ...
    async fn on_player_punch_air(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerPunchAirEvent>,
    ) {
    }
    ...
    async fn on_player_sign_edit(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerSignEditEvent>,
    ) {
    }
    ...
    async fn on_player_lectern_page_turn(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerLecternPageTurnEvent>,
    ) {
    }
    ...
    async fn on_player_item_damage(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemDamageEvent>,
    ) {
    }
    ...
    async fn on_player_item_pickup(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemPickupEvent>,
    ) {
    }
    ...
    async fn on_player_held_slot_change(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerHeldSlotChangeEvent>,
    ) {
    }
    ...
    async fn on_player_item_drop(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerItemDropEvent>,
    ) {
    }
    ...
    async fn on_player_transfer(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerTransferEvent>,
    ) {
    }
    ///Handler for the `Command` event.
    async fn on_command(&self, _server: &Server, _event: &mut EventContext<types::CommandEvent>) {}
    ///Handler for the `PlayerDiagnostics` event.
    async fn on_player_diagnostics(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::PlayerDiagnosticsEvent>,
    ) {
    }
    ...
    async fn on_world_liquid_flow(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldLiquidFlowEvent>,
    ) {
    }
    ...
    async fn on_world_liquid_decay(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldLiquidDecayEvent>,
    ) {
    }
    ...
    async fn on_world_liquid_harden(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldLiquidHardenEvent>,
    ) {
    }
    ...
    async fn on_world_sound(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldSoundEvent>,
    ) {
    }
    ...
    async fn on_world_fire_spread(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldFireSpreadEvent>,
    ) {
    }
    ...
    async fn on_world_block_burn(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldBlockBurnEvent>,
    ) {
    }
    ...
    async fn on_world_crop_trample(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldCropTrampleEvent>,
    ) {
    }
    ...
    async fn on_world_leaves_decay(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldLeavesDecayEvent>,
    ) {
    }
    ...
    async fn on_world_entity_spawn(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldEntitySpawnEvent>,
    ) {
    }
    ...
    async fn on_world_entity_despawn(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldEntityDespawnEvent>,
    ) {
    }
    ...
    async fn on_world_explosion(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldExplosionEvent>,
    ) {
    }
    ...
    async fn on_world_close(
        &self,
        _server: &Server,
        _event: &mut EventContext<types::WorldCloseEvent>,
    ) {
    }
}
#[doc(hidden)]
