...
pub fn generate_handler_trait(ast: &File, output_path: &PathBuf) -> Result<()> {
    ...
    let file = quote! {
        ...
        use crate::{event::EventContext, types, Server, EventSubscriptions};
        ...
        #[doc(hidden)]
        pub async fn dispatch_event(server: &Server, handler: &impl EventHandler, envelope: &types::EventEnvelope) {
